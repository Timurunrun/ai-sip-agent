...
Ответ должен содержать ТОЛЬКО JSON-объект с соответствующей условию структурой БЕЗ каких-либо дополнительных комментариев.
"""
...
def get_post_processor() -> PostCallProcessor:
    """Получает глобальный экземпляр пост-процессора"""
